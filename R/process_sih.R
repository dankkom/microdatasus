      ...
      data <- data %>%
        ...
        dplyr::mutate(
          ESPEC = dplyr::case_match(
            ...
            "92" ~
              "UCI Unidade de Cuidados Intermediarios Neonatal Convencional",
      ...
      data <- data %>%
        ...
        dplyr::mutate(
          NAT_JUR = dplyr::case_match(
            ...
            "1023" ~
              "\u00d3rg\u00e3o P\u00fablico do Poder Exec Estadual ou Distr Fed",
            "1031" ~
              "\u00d3rg\u00e3o P\u00fablico do Poder Executivo Municipal",
            "1040" ~
              "\u00d3rg\u00e3o P\u00fablico do Poder Legislativo Federal",
            "1058" ~
              "\u00d3rg\u00e3o P\u00fablico do Poder Legisl Estadual ou Dist Fed",
            "1066" ~
            ...
            "1171" ~
              "\u00d3rg\u00e3o P\u00fablico Aut\u00f4nomo Estadual ou Distr Federal",
            "1180" ~
              "\u00d3rg\u00e3o P\u00fablico Aut\u00f4nomo Estadual ou Distr Federal",
            ...
            "3204" ~
              "Estab no Brasil de Funda\u00e7\u00e3o ou Associa\u00e7\u00e3o Estrang",
            "3212" ~
      ...
      data <- data %>%
        ...
        dplyr::mutate(
          FAEC_TP = dplyr::case_match(
            ...
            "40009" ~
              "Atendimento/acompanhamento em reabilita\u00e7\u00e3o f\u00edsica, mental, visual, auditiva e m\u00faltiplas defic",
            ...
            "40013" ~
              "Atendimento/acompanhamento de diagn\u00f3stico de doen\u00e7as endocrinas/metab\u00f3licas e nutricionais",
            "40014" ~
            ...
            "40024" ~
              "Cirurgia do aparelho digestivo, org\u00e3os anexos e parede abdominal(inclui pr\u00e9 e p\u00f3s operat\u00f3rio)",
            ...
            "40042" ~
              "Reguladores de Atividade hormonal - Inibidores de prolactina",
            ...
            "40057" ~
              "Controle de qualidade do exame citopatol\u00f3gico do colo de \u00fatero",
            "40058" ~ "Exames do Leite Materno",
            "40059" ~
              "Aten\u00e7\u00e3o as Pessoas em Situa\u00e7\u00e3o de Viol\u00eancia Sexual",
            "40060" ~ "Sangue e Hemoderivados",
            "40061" ~
              "Mamografia para rastreamento em faixa et\u00e1ria recomendada",
            "40062" ~ "Doen\u00e7as Raras",
            ...
            "21012" ~
              "FAEC CNRAC (21012-c\u00f3d ant \u00e0 tab unif-v\u00e1l p/2008-01)",
            "21014" ~
              "FAEC Eletiv(21014-c\u00f3d ant \u00e0 tab unif-v\u00e1l p/2008-01)",
            "50000" ~ "Incentivo - MAC",
      ...
      data <- data %>%
        ...
        dplyr::mutate(
          REGCT = dplyr::case_match(
            ...
            "7101" ~
              "ESTABELECIMENTO DE SAUDE SEM GERACAO DE CREDITO NA MEDIA COMPLEXIDADE AMBULATORIAL",
            "7102" ~
              "ESTABELECIMENTO DE SAUDE SEM GERACAO DE CREDITO NA MEDIA COMPLEXIDADE HOSPITALAR",
            "7103" ~
              "ESTABELECIMENTO DE SAUDE SEM GERACAO DE CREDITO NA ALTA COMPLEXIDADE AMBULATORIAL",
            "7104" ~
              "ESTABELECIMENTO DE SAUDE SEM GERACAO DE CREDITO NA ALTA COMPLEXIDADE HOSPITALAR",
            "7105" ~
              "ESTABELECIMENTO DE SAUDE SEM GERACAO DE CREDITO PARA OS PROCEDIMENTOS FINANCIADOS COM O FAEC",
            "7106" ~
              "ESTABELECIMENTO SEM GERA\u00c7\u00c3O DE CREDITO TOTAL - EXCLUINDO FAEC",
            "7107" ~
              "ESTABELECIMENTO SEM GERACAO DE CREDITO NAS ACOES ESPEC. DE ODONTOLOGIA(INCENTIVO CEO I,II E III)",
            "7108" ~
              "ESTABELECIMENTO SEM GERACAO DE CREDITO(INCENTIVO A SAUDE DO TRABALHADOR)",
            "7109" ~ "ESTABELECIMENTO SEM GERACAO DE CREDITO TOTAL-MEC",
            "7110" ~
              "ESTABELECIMENTO DE SAUDE DA ESTRUTURA DO MINISTERIO DA SAUDE - SEM GERA\u00c7AO DE CREDITO TOTAL",
            "7111" ~
              "ESTABELECIMENTO DE SAUDE SEM GERACAO DE CREDITO - NASF, EXCETO FAEC",
            "7112" ~
              "ESTABELECIMENTO SEM GERA\u00c7\u00c3O DE CREDITO TOTAL - INCLUINDO FAEC  - EXCLUSIVO PARA REDE SARAH",
            "7113" ~
              "ESTABELECIMENTO SEM GERA\u00c7\u00c3O DE CREDITO TOTAL - INCLUINDO FAEC - OUTROS ESTABELECIMENTOS FEDERAIS",
            "7114" ~
              "ESTABELECIMENTO DE SA\u00daDE SEM GERA\u00c7\u00c3O DE CR\u00c9DITO TOTAL, INCLUSIVE FAEC - PRONTO ATENDIMENTO",
            "7115" ~
              "ESTABELECIMENTO DE SA\u00daDE SEM GERA\u00c7\u00c3O DE CR\u00c9DITO NA M\u00c9DIA COMPLEXIDADE - HU/MEC",
            "7116" ~
              "ESTABELECIMENTO DE SA\u00daDE SEM GERA\u00c7\u00c3O DE CR\u00c9DITO NA M\u00c9DIA COMPLEXIDADE - LRPD",
            "7117" ~
      ...
      data <- data %>%
        ...
        dplyr::mutate(
          ETNIA = dplyr::case_match(
            ...
            "0059" ~ "GUARANI M'BYA",
            "0060" ~
              "GUARANI NANDEVA (AVAKATUETE, CHIRIPA,NHANDEWA, AVA GUARANI)",
            "0061" ~ "GUATO",
            ...
            "0161" ~
              "NAMBIKWARA DO NORTE (NEGAROTE ,MAMAINDE, LATUNDE, SABANE E MANDUKA, TAWANDE)",
            "0162" ~
              "NAMBIKWARA DO SUL (WASUSU ,HAHAINTESU, ALANTESU, WAIKISU, ALAKETESU, WASUSU, SARARE)",
            ...
            "0209" ~ "TINGUI BOTO",
            "0210" ~
              "TIRIYO EWARHUYANA (TIRIYO, TRIO, TARONA, YAWI, PIANOKOTO)",
