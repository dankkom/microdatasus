...
process_sia <- function(
  ...
  if (information_system == "SIA-PA") {
    ...
    if ("PA_REGCT" %in% variables_names) {
      data <- data %>%
        dplyr::mutate(
          PA_REGCT = dplyr::case_match(
            .data$PA_REGCT,
            "7100" ~
              "TAB.DE N\u00c3O GERA\u00c7\u00c3O CR\u00c9DITO P/PROD.INTERN./AMBULAT.",
            ...
            "7105" ~
              "ESTAB.S/CRED.PROCED.FINANC.FD.A\u00c7\u00d5ES ESTRAT/COMPENS.",
            "7106" ~
              "ESTABELECIM. DE SA\u00daDE SEM GERA\u00c7\u00c3O DE CR\u00c9DITO TOTAL",
            "7107" ~ "ESTAB.S/CR\u00c9DITO ACOES ESPEC.ODONT(INC.CEO I,II,III)",
            "7108" ~ "ESTAB.S/GER.CR\u00c9DITO(INCENTIVO SAUDE DO TRABALHADOR)",
            "7109" ~
              "ESTAB.SA\u00daDE (HU/MEC) SEM GERA\u00c7\u00c3O DE CR\u00c9DITO TOTAL",
            "7110" ~
              "ESTAB.SAUDE (MIN.SAUDE)SEM GERA\u00c7\u00c3O DE CR\u00c9DITO TOTAL",
            "7111" ~
              "ESTAB.SAUDE SEM GERA\u00c7\u00c3O DE CR\u00c9DITO-NASF,exceto FAEC",
            "7112" ~ "ESTAB.S/CRED.TOTAL-INCL.FAEC-EXCLUSIVO P/REDE SARAH",
            "7113" ~ "ESTAB.S/CRED.TOTAL,INCL.FAEC-OUTROS ESTAB. FEDERAIS",
            "7116" ~
              "ESTAB.SA\u00daDE S/GER DE CR\u00c9DITO NA M\u00c9DIA COMPLEX-LRPD",
            "7117" ~
              "ESTAB.SA\u00daDE S/GER DE CR\u00c9D. M\u00c9D COMP(EXCETO OPM)-CER",
      ...
      data <- data %>%
        dplyr::mutate(
          PA_MOTSAI = dplyr::case_match(
            ...
            "24" ~
              "PERMAN. POR PROCESSO-DOA\u00c7\u00c3O DE \u00d3RG\u00c3OS-DOADOR VIVO",
            "25" ~
              "PERMAN. POR PROCESSO-DOA\u00c7\u00c3O DE \u00d3RG\u00c3OS-DOADOR MORTO",
            ...
            "41" ~
              "\u00d3BITO COM DECLARA\u00c7\u00c3O DE \u00d3BITO FORNEC. M\u00c9DICO ASSIST",
            "42" ~
              "\u00d3BITO COM DECLARA\u00c7\u00c3O DE \u00d3BITO FORNECIDA PELO I.M.L",
            "43" ~
              "\u00d3BITO COM DECLARA\u00c7\u00c3O DE \u00d3BITO FORNECIDA PELO I.M.L",
            "51" ~ "ENCERRAMENTO ADMINSTRATIVO",
            "00" ~
              "PRODU\u00c7\u00c3O SEM MOTIVO DE SA\u00cdDA (BPA-C / BPA-I)",
